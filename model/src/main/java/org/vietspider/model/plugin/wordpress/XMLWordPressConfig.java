...
@NodeMap("wordpress-config")
public class XMLWordPressConfig extends PluginConfig {
...
//  public void setBoundary(String boundary) { this.boundary = boundary; }
  ...
  private String postAddress = "http://localhost/wordpress/wp-admin/post-new.php";
  ...
  @NodeMap("post-image-url")
  private String postImageURL = "";
  @GetterMap("post-image-url")
  public String getPostImageURL() { return postImageURL; }
  @SetterMap("post-image-url")
  public void setPostImageURL(String address) { postImageURL = address;}
  ...
  @NodeMap("image-start-url")
  private String imageStartURL = "";
  @GetterMap("image-start-url")
  public String getImageStartURL() { return imageStartURL;  }
  @SetterMap("image-start-url")
  public void setImageStartURL(String imageStartURL) { this.imageStartURL = imageStartURL; }
