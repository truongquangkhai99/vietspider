...
public class ViewerSelectorContentProposalProvider extends ViewerContentProposalProvider  {
	 ...
	 *            requested.
	 */
	public ViewerSelectorContentProposalProvider(String[] proposals, Combo combo) {
		super(proposals);
		this.control = combo;
	}
	 ...
	 *            requested.
	 */
	public ViewerSelectorContentProposalProvider(String[] proposals, Text text) {
		super(proposals);
		this.control = text;
	}
