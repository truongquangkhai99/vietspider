...
public class SimpleWriter {
	...
	private static void writeNumberFormatSheet(WritableSheet s) throws WriteException {
	 ...
	 * @param s 
	 */
	private static void writeDateFormatSheet(WritableSheet s) throws WriteException {
	 ...
	 * @param s1 
	 */
	private static void writeLabelFormatSheet(WritableSheet s1) throws WriteException {
		...
		lr = new Label(1, 2, "Thuan");
		s1.addCell(lr);
		
		lr = new Label(4, 2, "Thuan 2");
		s1.addCell(lr);
	 ...
	 * @param s
	 */
	private static void writeBordersSheet(WritableSheet s) throws WriteException {
	 ...
	 */
	private static void writeFormulaSheet(WritableWorkbook workbook, WritableSheet ws) throws WriteException {
	 ...
	 */
	private static void writeImageSheet(WritableSheet ws) throws WriteException {
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File("D:\\Temp\\csv\\test.xls");
