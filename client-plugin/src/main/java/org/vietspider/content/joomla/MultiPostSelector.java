...
//        System.out.println(" == > "+ licenseFile.getAbsolutePath());
        ...
        for(int i = 0; i < selectors.length; i++) {
          JoomlaSyncData syncData = selectors[i].getSyncData();
...
//    XPWidgetTheme.setWin32Theme(shell);
  ...
  public void setPlugin(JoomlaSyncArticlesPlugin plugin) {
    this.plugin = plugin;
  }
