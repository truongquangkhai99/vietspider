 ...
 * Nov 19, 2011  
 */
public class TranslationToCnPlugin extends ClientPlugin {

  private String label;
  //private String confirm;
  private int type = CONTENT;

  public TranslationToCnPlugin() {
    ClientRM resources = TranslationPlugin.getResources();
    label = resources.getLabel(TranslationPlugin.class.getName() + ".itemTranslationToCn");
  ...
  public void invoke(Object... objects) {
    ...
    if(idx < 0) return;
    url = url.substring(0, idx) + "/TRANSLATOR/" + values[0] +"/?to=zh-CHS";
    control.setUrl(url);
  }
