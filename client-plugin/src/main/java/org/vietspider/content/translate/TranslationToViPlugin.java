 ...
 * Nov 19, 2011  
 */
public class TranslationToViPlugin extends ClientPlugin {

  private String label;
  //private String confirm;
  private int type = CONTENT;

  public TranslationToViPlugin() {
    ClientRM resources = TranslationPlugin.getResources();
    label = resources.getLabel(TranslationPlugin.class.getName() + ".itemTranslationToVi");
  ...
  public void invoke(Object... objects) {
    ...
    if(idx < 0) return;
    url = url.substring(0, idx) + "/TRANSLATOR/" + values[0] +"/?to=vi";
    control.setUrl(url);
  }
