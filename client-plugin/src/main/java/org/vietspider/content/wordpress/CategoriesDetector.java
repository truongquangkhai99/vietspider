...
//    System.out.println("chuan bi login " + loginURL);
...
//    System.out.println("query toi "+url);
...
//    System.out.println(document.getTextValue());
    ...
    while(iterator.hasNext()) {
      ...
      if(attribute == null 
          || !"post_category[]".equals(attribute.getValue())) continue;
      ...
      if(!parent.getChild(idx+1).isNode(Name.CONTENT)) continue;
