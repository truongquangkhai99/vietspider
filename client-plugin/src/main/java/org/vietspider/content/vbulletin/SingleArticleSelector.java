  ...
  public SingleArticleSelector(Composite parent, int index) {
    ...
    cboCategory.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        ...
        boolean license_ = LicenseVerifier.verify("vbulletin", licenseFile_);
        if(license_) return;
...
//    joomlaSyncData.setFrontpage(butFrontpage.getSelection());
