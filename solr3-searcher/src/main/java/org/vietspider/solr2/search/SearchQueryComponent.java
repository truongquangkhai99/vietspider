 ...
 * Jan 6, 2010  
 */
public class SearchQueryComponent extends QueryComponent {
  
  public static final String VS_COMPONENT_NAME = "vsquery";
...
//    QParserPlugin qplug = req.getCore().getQueryPlugin(type);
    return new SearchQueryParser(qstr, localParams, req.getParams(), req);
  }   
