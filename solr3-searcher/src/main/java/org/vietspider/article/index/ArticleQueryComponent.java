 ...
 * Jan 6, 2010  
 */
public class ArticleQueryComponent extends QueryComponent {
  
  public static final String VS_COMPONENT_NAME = "article_query";
...
//    QParserPlugin qplug = req.getCore().getQueryPlugin(type);
    return new ArticleSolrQueryParser(qstr, localParams, req.getParams(), req);
  }   
