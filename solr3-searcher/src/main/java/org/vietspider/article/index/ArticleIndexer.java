 ...
 * Dec 29, 2009  
 */
public abstract class ArticleIndexer extends IDatabases {

  private volatile boolean execute = true; 

  public ArticleIndexer() throws Exception {
    super(DatabaseService.SEARCH);

    Application.addShutdown(new Application.IShutdown() {
      public String getMessage() { return "Close Article Index Storage";}
      public void execute() {
        execute = false; 
        exit();
      }
