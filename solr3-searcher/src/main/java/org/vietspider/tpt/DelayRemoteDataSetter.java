...
import org.vietspider.db.remote.SyncImageData;
 ...
 * Feb 8, 2007
 */
public class DelayRemoteDataSetter implements DatabaseWriter {

//  private ArticleDatabases backup;

  public DelayRemoteDataSetter() {
...
//    IDVerifiedStorages.save("backup", article);
