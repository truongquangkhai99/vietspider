 ...
 * Nov 22, 2007  
 */
class LoaderListSort extends RandomAccess {
...
//  private long lastAccess = -1;
  ...
  LoaderListSort(File file) {
    SystemProperties properties = SystemProperties.getInstance();
    String schedule = properties.getValue("website.generate.schedule");
    if(schedule == null || "-1".equals(schedule.trim()))  sort = true;
