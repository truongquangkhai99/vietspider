 ...
 * Jan 6, 2010  
 */
public class TpSolrQueryComponent extends QueryComponent {
  
  public static final String VS_COMPONENT_NAME = "ctpt_query";
...
//    QParserPlugin qplug = req.getCore().getQueryPlugin(type);
    return new TpSolrQueryParser(qstr, localParams, req.getParams(), req);
  }   
