...
public class AreaTestSingle {
  ...
  public static void main(String[] args) throws Exception {
    String folder_path = "D:\\Temp\\area_testcase\\";
//    String folder_path = "D:\\Temp\\no_mail\\";
    File file = new File(folder_path + "b49.txt");//"a32.txt");
    if(!file.exists()) {
      System.err.println("file not found!");
      return;
    }
    
    AreaFilter.TEST = true;
    ...
    Collection<?> values = map.get(NLPData.AREA);
    ...
    if(values != null) {
      ...
      while(iterator.hasNext()) {
        System.out.println("area: "+ iterator.next().toString());
      }
    }
  }
